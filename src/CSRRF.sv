...
(
  ...
  // 本体.
  csr_reg_u csr_regs[64];
  csr_reg_u csr_regs_init[64];
  ...
  always_ff @(posedge clock) begin
    if (reset) begin
      ...
      if (renamer_port.minstret_w.en) begin
        csr_regs[internal_idx(MINSTRET)] <= renamer_port.minstret_w.data;
      end
