...
package CACHE_PROPS;
  ...
  //   logic [VADDR_WIDTH-1:0] vaddr_db_aligned;
  //   // piptならpaddr_valid==1でpaddrを渡す(この時vaddrは使用しない).viptならpaddr_valid==0
  //   logic paddr_valid;
  //   logic [PADDR_WIDTH-1:0] paddr_db_aligned;
  //   logic [$clog2(DW_SIZE)-1:0] byte_in_db_idx;
