...
XMicroblaze_Config XMicroblaze_ConfigTable[] __attribute__ ((section (".drvcfg_sec"))) = {
	{
		...
		0x0,  /* xlnx,edge-is-positive */
		 0,  /* timebase-frequency */
		0x1,  /* xlnx,endianness */
		 0,  /* xlnx,fsl-data-size */
		0x0,  /* xlnx,fsl-links */
		0x0,  /* xlnx,icache-always-used */
		...
		0x7ff00000,  /* microblaze_ddr_reserve_sa */
		0x7fffffff,  /* microblaze_ddr_reserve_ea */
		0x0,  /* reg */
		0xffd00000  /* xlnx,base-vectors */
	}
};